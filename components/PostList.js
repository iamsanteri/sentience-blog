...
const PostList = (pageIdentifier) => {
    return (
        <>
            <section className="lg:pt-4 pb-12">
                <div className="mx-7 lg:mx-32 lg:px-32 xl:mx-64 xl:px-42 2xl:mx-72 2xl:px-48">
                    <a className="flex justify-between group" href="#">
                        <span className="flex text-lg py-3 dark:text-white group-hover:opacity-75">My first post</span>
                    ...
                    <hr className='dark:opacity-10 h-0.5' />
                </div>
                <div className="mx-7 lg:mx-32 lg:px-32 xl:mx-64 xl:px-42 2xl:mx-72 2xl:px-48">
                    <a className="flex justify-between group" href="#">
