        ...
        <>
            <section className="lg:pt-4 pb-6 feed-group">
                ...
                <div className="grid place-content-center">
                    <div className="px-3 py-2 text-xs border rounded border-gray-200 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 hover:cursor-pointer dark:text-white" onClick={ loadMore } style={{ display: showAmount + 1 > filteredList.length ? "none" : "block"}}>LOAD MORE</div>
                </div>
            </section>
        </>
    );
