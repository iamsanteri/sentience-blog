        ...
        <section className="bg-white dark:bg-sentient pt-14 mb-4 lg:mb-10 lg:pt-24">
            <div className="w-full flex justify-center">
                <div className="p-5 md:w-3/4 lg:w-3/5 xl:w-2/4 2xl:w-2/5">
                    ...
                    <article className="prose-lg text-lg lg:prose-xl text-gray-700 dark:text-gray-300">
                        <p>I set up Sentience to experiment with different writing styles I'd never use elsewhere. Among others, here you'll find all sorts of fictional essays that are short and descriptive in nature.</p>
                        <p>Why?</p>
                        ...
                        <p>If I'd only manage to create a fraction of what I consume, I think I'd be a better human being. Who knows, I could even end up helping some other people too. And hey, I won't even complain that English isn't my native language! </p>
