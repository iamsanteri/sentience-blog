            ...
            <div className="w-full flex justify-center">
                <div className="p-5 md:w-3/4 lg:w-3/5 xl:w-2/4 2xl:w-2/5">
                    ...
                    <article style={{ lineHeight: 2 + "rem"}} className="prose prose-lg lg:prose-xl text-gray-700 dark:text-gray-300">
                        ...
                        <p>Why?</p>
                        <p>Because writing as media, in addition to human labor and financial capital, are core forms of <a href="https://www.lostbookofsales.com/notes/the-almanack-of-naval-ravikant-by-eric-jorgenson/?ref=sentience#leverage" className="dark:text-zinc-200 hover:opacity-75">modern leverage</a>.</p>
