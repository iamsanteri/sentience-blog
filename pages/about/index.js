            ...
            <div className="w-full flex justify-center">
                <div className="p-5 md:w-3/4 lg:w-3/5 xl:w-2/4 2xl:w-2/5">
                    ...
                    <article className="prose-lg text-lg lg:prose-xl text-gray-700 dark:text-gray-300">
                        ...
                        <p>Finally, there is something timeless and magical about writing that is endlessly difficult to master. It's like a form of art with infinite amounts of variety that most of us never manage to grasp with fluency. One perspective is to look at it as a lifelong craft or a hobby bringing you joy and fulfillment. </p>
                        <p>And so, I'm willing to explore it further. </p>
                        <p>If I could only manage to create a fraction of what I consume, I think I'd be a better human being. Who knows, I could even end up helping some other people too. And hey, I won't even complain that English isn't my native language! </p>
