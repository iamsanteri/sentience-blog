        ...
        <section className="bg-white dark:bg-sentient pt-14 mb-4 pb-7 lg:mb-10 lg:pt-32">
            <div className="w-full flex justify-center">
                <div className="p-5 md:w-3/4 lg:w-3/5 xl:w-2/4 2xl:w-2/5">
                    ...
                    <article className="prose text-xl lg:prose-xl prose-strong:dark:text-gray-300 prose-a:dark:text-zinc-200 prose-a:hover:opacity-75 text-gray-700 dark:text-gray-300 dark:prose-invert" dangerouslySetInnerHTML={{ __html: postData.contentHtml }} />
                </div>
            </div>
        </section>
